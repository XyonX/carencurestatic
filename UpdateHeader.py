...
new_code_file_name = "zheader.html"  # File containing the new <div> code
...
def process_html_file(html_file_path):
    try:
        ...
        if old_div and new_div:
            ...
            print(f"Replaced 'header' div in {html_file_path}")
        elif not old_div:
            print(f"Warning: No div with id 'header' found in {html_file_path}")
        elif not new_div:
            print(f"Warning: No div with id 'header' found in {new_code_file_name}")
