...
def process_html_file(html_file_path):
    try:
        ...
        new_div = BeautifulSoup(new_code_html, "html.parser").find("div", id="top-hospitals")

        # Find the existing <div> with id="top-hospitals" in the original HTML
        old_div = soup.find("div", id="top-hospitals")
