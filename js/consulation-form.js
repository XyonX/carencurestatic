...
function validateContactForm(){ 
	...
	$.post("/includes/contact-form-submit.php", { name: name, sex: sex, age: age, email: email, address: address, city: city, country: country, phone: phone, mobile: mobile, message: message, hospitalsurgeon: hospitalsurgeon, personal: personal, page: page, g_response: grecaptcha.getResponse(0) },
	function(data, status){
		if(data == 'Message sent!'){
